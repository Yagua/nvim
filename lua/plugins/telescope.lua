return {
  {
    ...
    config = function(_, opts)
      ...
      require('utils').set_keymap({
        { 'n', '<leader>te', '<CMD>Telescope<CR>', { desc = 'Telescope: Builtin' } },
        { 'n', '<leader>bk', builtin.buffers, { desc = 'Telescope: Buffers' } },
        { 'n', '<c-p>', builtin.git_files, { desc = 'Telescope: Git files' } },
        { 'n', '<leader>th', builtin.help_tags, { desc = 'Telescope: Help tags' } },
        { 'n', '<leader>gs', builtin.find_files, { desc = 'Telescope: Find files' } },
        { 'n', '<leader>td', builtin.diagnostics, { desc = 'Telescope: Diagnostics' } },
